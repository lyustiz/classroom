        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
                        <td class="text-xs-left">{{ item.co_notificacion }}</td>
						...
						<td class="text-xs-left">{{ item.id_tipo_notificacion }}</td>
...
export default {
    mixins:     [ listHelper],
    components: { 'notificacion-form': notificacionForm },
    data () {
    return {
        title:    'Notificacion',
        resource: 'notificacion',
        headers: [
            { text: 'Notificacion',      value: 'co_notificacion' },
			...
			{ text: 'Tipo Notificacion', value: 'id_tipo_notificacion' },
			{ text: 'Tipo Priodidad',    value: 'id_tipo_prioridad' },
