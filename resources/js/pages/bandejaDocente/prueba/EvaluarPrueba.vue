                            ...
                            <tr>
                                ...
                                <td class="text-xs-left py-1">
                                    ...
                                    <template>
                                        ...
                                        <v-dialog v-model="dialogEvaluar" max-width="500" content-class="rounded-xl" scrollable>
                                            <evaluar-prueba-alumno 
                                                :item="item" action="upd" v-if="dialogEvaluar" @closeModal="closeDialog($event,'dialogEvaluar')"
                                            ></evaluar-prueba-alumno>
                                        </v-dialog>
                                    </template>
