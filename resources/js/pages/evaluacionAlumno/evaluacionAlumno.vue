        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
                        <td class="text-xs-left">{{ item.id_evaluacion }}</td>
...
import evaluacionAlumnoForm  from './evaluacionAlumnoForm';
export default {
    mixins:     [ listHelper],
    components: { 'evaluacion-alumno-form': evaluacionAlumnoForm },
    data () {
    return {
        title:    'EvaluacionAlumno',
        resource: 'evaluacionAlumno',
        headers: [
            { text: 'Evaluacion',   value: 'id_evaluacion' },
