...
import actividadGrupoForm  from './actividadGrupoForm';
export default {
    mixins:     [ listHelper],
    components: { 'actividad-grupo-form': actividadGrupoForm },
    data () {
    return {
        title:    'ActividadGrupo',
        resource: 'actividadGrupo',
        headers: [
