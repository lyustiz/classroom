...
import profesorMateriaForm  from './profesorMateriaForm';
export default {
    mixins:     [ listHelper],
    components: { 'profesor-materia-form': profesorMateriaForm },
    data () {
    return {
        title:    'ProfesorMateria',
        resource: 'profesor_materia',
        headers: [
