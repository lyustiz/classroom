...
export default {
    ...
    methods: 
    {
        ...
        update()
        {
            ...
            axios.put(this.apiUrl    + this.resource + '/location', this.form)
			.then( response =>
			{
        ...
        getComunas(){
            ...
            axios.get(this.apiUrl    + 'comuna/zona/' + this.form.id_zona)
			.then( response =>
			{
        ...
        getBarrios(){
            ...
            axios.get(this.apiUrl    + 'barrio/comuna/' + this.form.id_comuna)
			.then( response =>
			{
