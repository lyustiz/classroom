            ...
            <v-row no-gutters>
              <v-col class="text-center">
                <v-avatar color="grey lighten-5" size="48">
                  <item-menu icon="mdi-bookshelf" btn-color="white" :icon-color="materia.area_estudio.tx_color" :menus="itemsMenu" :item="materia" @onItemMenu="onItemMenu($event)"></item-menu>
                </v-avatar>
              </v-col>
              <v-col cols="12">
