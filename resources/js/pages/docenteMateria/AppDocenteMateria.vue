...
export default {
    ...
    {
        this.list();
        this.default.id_docente = this.idDocente
    },
    data() {
        return {
            resource: 'docenteMateria',
            materias: [],
            form:
            {
                id: 	          null,
    ...
    methods:
    {
        ...
        {
            this.materias = []
            let resource  = 'docenteMateria/docente/' + this.idDocente
            this.getResource( resource ).then( data =>  {
                this.materias = data.docenteMateria
        ...
        addMateria(materia)
        {
            ...
            this.storeResource(this.resource, this.form).then( (data) =>  
            {
                ...
                this.materias.push({ 
                    id: data.docenteMateria.id , 
                    id_materia: data.docenteMateria.id_materia,
                    nb_materia: data.docenteMateria.materia.nb_materia 
                })
        ...
        deleteMateria(item){
            let resourceId  = 'docenteMateria/' + item.id
