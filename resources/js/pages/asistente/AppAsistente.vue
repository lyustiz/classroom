...
export default {
    ...
    ({
        steps: [
            ...
            { label: 'Grupo Calif.',     color: 'purple',  route: 'horario',         resource: 'horario',        icon: 'mdi-check-box-multiple-outline',       warnings: 'Descripcion de la tarea de especial cuidado para el funcionamiento del sistema', detail: 'Descripcion de la funcionalidad, observaciones y advertencias'   },
            { label: 'Nivel Calif.',     color: 'purple',  route: 'horario',         resource: 'horario',        icon: 'mdi-check-box-multiple-outline',       warnings: 'Descripcion de la tarea de especial cuidado para el funcionamiento del sistema', detail: 'Descripcion de la funcionalidad, observaciones y advertencias'   },
            { label: 'Calificacion',     color: 'purple',  route: 'horario',         resource: 'horario',        icon: 'mdi-check-box-outline',                warnings: 'Descripcion de la tarea de especial cuidado para el funcionamiento del sistema', detail: 'Descripcion de la funcionalidad, observaciones y advertencias'   },
