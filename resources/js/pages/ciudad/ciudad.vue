        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
                        <td class="text-xs-left">{{ item.co_ciudad }}</td>
						<td class="text-xs-left">{{ item.nb_ciudad }}</td>
...
export default {
    mixins:     [ listHelper],
    components: { 'ciudad-form': ciudadForm },
    data () {
    return {
        title:    'Ciudad',
        resource: 'ciudad',
        headers: [
            { text: 'Ciudad',   value: 'co_ciudad' },
			{ text: 'Ciudad',   value: 'nb_ciudad' },
    ...
    methods:
    {
        ...
        delItem()
        {
            axios.delete(this.apiUrl    + 'ciudad/'+this.item.id)
            .then(response => {
