        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
                        <td class="text-xs-left">{{ item.nb_tipo_mensaje }}</td>
...
import tipoMensajeForm  from './tipoMensajeForm';
export default {
    mixins:     [ listHelper],
    components: { 'tipo-mensaje-form': tipoMensajeForm },
    data () {
    return {
        title:    'Tipo Mensaje',
        resource: 'tipoMensaje',
        headers: [
            { text: 'Tipo Mensaje',  value: 'nb_tipo_mensaje' },
