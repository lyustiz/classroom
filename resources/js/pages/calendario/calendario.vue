...
export default {
    mixins:     [ listHelper],
    components: { 'calendario-form': calendarioForm },
    data () {
    return {
        title:    'Calendario',
        resource: 'calendario',
    ...
    methods:
    {
        list () {
            ...
            axios.get(this.apiUrl  +'calendario')
            .then(response => {
        ...
        delItem()
        {
            axios.delete(this.apiUrl    + 'calendario/'+this.item.id)
            .then(response => {
