        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
						<td class="text-xs-left">{{ item.tipo_directiva.nb_tipo_directiva }}</td>
                        <td class="text-xs-left">{{ item.cargo.nb_cargo }}</td>
                        <td class="text-xs-left">{{ item.nb_directiva }}</td>
...
export default {
    mixins:     [ listHelper],
    components: { 'directiva-form': directivaForm },
    data () {
    return {
        title:    'Directiva',
        resource: 'directiva',
        headers: [
            { text: 'Tipo Directiva',   value: 'tipo_directiva.nb_tipo_directiva' },
