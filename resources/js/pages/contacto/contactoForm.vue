<template>
    ...
    <v-card :loading="loading" >
        ...
        <v-col cols="12" md="6">
            <v-select
            :items="selects.tipo_contacto"
            item-text="nb_tipo_contacto"
            item-value="id"
