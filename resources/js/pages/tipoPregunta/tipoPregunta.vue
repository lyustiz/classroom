        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
                        <td class="text-xs-left">{{ item.nb_tipo_pregunta }}</td>
...
import tipoPreguntaForm  from './tipoPreguntaForm';
export default {
    mixins:     [ listHelper],
    components: { 'tipo-pregunta-form': tipoPreguntaForm },
    data () {
    return {
        title:    'Tipo Pregunta',
        resource: 'tipoPregunta',
        headers: [
            { text: 'Tipo Pregunta',   value: 'nb_tipo_pregunta' },
