        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
                        <td class="text-xs-left">{{ item.co_zona }}</td>
						<td class="text-xs-left">{{ item.nb_zona }}</td>
...
export default {
    mixins:     [ listHelper],
    components: { 'zona-form': zonaForm },
    data () {
    return {
        title:    'Zona',
        resource: 'zona',
        headers: [
            { text: 'Zona',   value: 'co_zona' },
			{ text: 'Zona',   value: 'nb_zona' },
    ...
    methods:
    {
        ...
        delItem()
        {
            axios.delete(this.apiUrl    + 'zona/'+this.item.id)
            .then(response => {
