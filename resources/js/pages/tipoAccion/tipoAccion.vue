        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
                        <td class="text-xs-left">{{ item.nb_tipo_accion }}</td>
...
import tipoAccionForm  from './tipoAccionForm';
export default {
    mixins:     [ listHelper],
    components: { 'tipo-accion-form': tipoAccionForm },
    data () {
    return {
        title:    'Tipo Accion',
        resource: 'tipoAccion',
        headers: [
            { text: 'Tipo Accion',   value: 'nb_tipo_accion' },
