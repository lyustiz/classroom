<template>
    ...
    <v-card :loading="loading" flat>
        ...
        <v-col cols="12" md="6">
            <v-select
            :items="selects.tipoDestinatario"
            item-text="nb_tipo_destinatario"
            item-value="id"
            v-model="form.id_tipo_destinatario"
            :rules="[rules.select]"
        ...
        <v-col cols="12" md="6">
            <v-select
            :items="selects.destinatario"
            item-text="nb_destinatario"
            item-value="id"
            v-model="form.id_destinatario"
            :rules="[rules.select]"
            label="Destinatario"
            :loading="loading"
            dense
        ...
        <v-col cols="12" md="6">
            <v-menu
                v-model="pickers.fe_lectura"
                :close-on-content-click="false"
                min-width="290px"
            >
                <template v-slot:activator="{ on }">
                    <v-text-field
                        v-model="dates.fe_lectura"
                        :rules="[rules.fecha]"
                        label="Lectura"
                        prepend-icon="event"
                        readonly
                ...
                <v-date-picker 
                    v-model="form.fe_lectura" 
                    @input="dates.fe_lectura = formatPicker(form.fe_lectura, 'fe_lectura')">
                </v-date-picker>
            </v-menu>
        </v-col> 
        <v-col cols="12" md="6">
