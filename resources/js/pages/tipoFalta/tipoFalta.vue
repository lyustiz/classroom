        ...
        <template slot="HeadTools">
            ...
            >
                ...
                <template v-slot:item="{ item }">
                    <tr>
                        <td class="text-xs-left">{{ item.nb_tipo_falta }}</td>
...
import tipoFaltaForm  from './tipoFaltaForm';
export default {
    mixins:     [ listHelper],
    components: { 'tipo-falta-form': tipoFaltaForm },
    data () {
    return {
        title:    'TipoFalta',
        resource: 'tipoFalta',
        headers: [
            { text: 'Tipo Falta',   value: 'nb_tipo_falta' },
