...
export default {
    ...
    methods: {
        ...
        horarioWeek(start, end)
        {
            ...
            for (const horarios of this.horario) {

                let grupo = horarios.grupo.nb_grupo

                for (const horario of horarios.detalle_horario) {
            ...
            this.allEvents = allHorarios.concat(this.events);
        },
